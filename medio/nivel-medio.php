 ...
 <body style="background-image: url('../imagenes/tablero.png'); background-size: 1365px 662px; color:white;">
 		...
 		<div class="row">
 			<div class="col-md-6 mx-auto" style="line-height: 250%">
 				...
 				<div style="position: relative; top: 100px;">
 					...
 					<form id="scoreForm" action="recibe-medio.php" method="get" style="display: none;">
 						<input type="hidden" id="scoreInput" name="score" value="0">
 						<input type="hidden" id="objetive" name="objetivo" value="25">
 	...
 	<script>
 		...
 		const words = [
 			'CortaR', 'GraciaS', 'EncantadoR', 'PesO', 'PesadO', 'EmitiR', 'GrasA', 'SusurraR',
 			'CerdO', 'FondO', 'AlmendrA', 'CoseR', 'CangrejO', 'ArquitectO', 'FantasmA', 'ExcesO',
 			'CaballoS', 'FuerzA', 'ActriZ', 'PerseguiR', 'BandA', 'PieS', 'SecundariO', 'DecisivO',
 			'ClasificaR', 'ActuaR', 'EstruendosO', 'CaminO', 'NegritA', 'ComportarsE', 'CubO', 'BombarderO',
 			'CompactO', 'AcariciaR', 'SimilaR', 'DespachO', 'EnviaR', 'PeleA', 'PuñoS', 'ReemplazaR',
 			'AbandonaR', 'RespondeR', 'MarcaR', 'MezcladA', 'SacO', 'GiraR', 'ApresurarsE', 'EntreteneR',
 			'BolsillO', 'EstablE', 'AuspiciosO', 'RayO'
 		];
