...
<body style="background-image: url('../imagenes/pre---ejercicio.jpg'); background-size: 1365px 662px; color:white;">
	...
	<h1 align="center" style="color: white; line-height: 0%; text-shadow: 4px 4px 8px #333; position: relative; top: -5px;"> BIENVENIDO AL JUEGO COMPLETO</h1>
	...
	<div style="position:absolute; top: 150px; left: 60px">
		...
		<br>
		<h4 align="center">--- Tendrá 10 segundos por palabra, PERO ---</h4>
				<p align="center">--- Cada vez que aumente tu puntaje, se irá reduciendo el tiempo que tendrás para teclear cada palabra ---</p><br>
						<! –– y cada vez que aumente tu puntaje, se irá reduciendo el tiempo que tendrás para teclear cada palabra ––>
							<h3 align="center" style="line-height: 20%">Completa <b>50</b> palabras para completar el juego</h3> <br>
							<h4 align="center">En este nivel encontrarás: </h4>
							<h4 align="center">Palabras en mayúsculas, minúsculas, números y simbolos</h4>
	</div>
	...
	<div style="position:absolute; top: 170px; left: 940px">
		...
		echo "<tr> <th bgcolor='black' colspan='2' height='40'> Mejores puntuaciones - Completo </th> </tr>";
	...
	<br><br>
	<div style="position:absolute; top: 590px; left: 330px">
		<a class="boton_personalizado" href="nivel-completo.php">Iniciar NIVEL COMPLETO</a>
		<style type="text/css">
			.boton_personalizado {
				padding: 10px;
				font-weight: 600;
