 	...
 	<div style="text-align: center;">
 		...
 		<?php
			if ($nombre == $objetivo) { ?>
 			...
 			<p style="text-align: center; line-height: 100%; position: relative; top: -10px;">
 				<b>
 					<p align="center" style="line-height: 100%"><b>
 							<font size=7>Haz pasado el nivel COMPLETO del Proyecto Me-K-No </font>
 						</b></p>
 				</b>
 			</p>
 			<br><br>
 			...
 			<form action="guardar-completo.php" method="POST">
 		...
 		<?php
			...
			?>
 			...
 			<p style="text-align: center; line-height: 100%; position: relative; top: -10px;">
 				<b>
 					<font size="7">Te falta poco para pasar el nivel COMPLETO</font>
 				</b>
 			</p>
 			<br><br>
 			<h5 style="text-align: center; position: relative; top: 20px;">Registra tu nombre para guardar tu puntuación</h5>
 		...
 		<?php
			...
			?>
 		<!--<p style="text-align: center;" style="line-height: 100%"><b>
 				<font size=7>Te falta poco para pasar el nivel FÁCIL</font>
 			</b></p>
 		<br><br>
 		<h5 style="text-align: center;">Registra tu nombre para guardar tu puntuación</h5>
 		<! –– y cada vez que aumente tu puntaje, se irá reduciendo el tiempo que tendrás para teclear cada palabra ––>


 			<form action="1-5-1-store.php" method="POST">
 				<label for="nombre"></label><br>
