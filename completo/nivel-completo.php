 ...
 <body style="background-image: url('../imagenes/tablero.png'); background-size: 1365px 662px; color:white;">
 	...
 	<div style="position:absolute; top: 13px; left: 15px">
 		<a href="inicio-completo.php"> <img src="../imagenes/regreso.png" alt="" width="60" height="60" /></a>
 	</div>
 		...
 		<div class="row">
 			<div class="col-md-6 mx-auto" style="line-height: 250%">
 				...
 				<div style="position: relative; top: 100px;">
 					...
 					<form id="scoreForm" action="recibe-completo.php" method="get" style="display: none;">
 						<input type="hidden" id="scoreInput" name="score" value="0">
 						<input type="hidden" id="objetive" name="objetivo" value="50">
 	...
 	<script>
 		...
 		const currentLevels = [levels.easy, levels.medium, levels.hard, levels.very, levels.finish];
 		...
 		const words = [
 			'cortar', 'gracias', 'encantador', 'peso', 'pesado', 'emitir', 'grasa', 'susurrar', 'cerdo', 'fondo', 'almendra',
 			'coser', 'cangrejo', 'arquitecto', 'fantasma', 'exceso', 'caballos', 'fuerza', 'actriz', 'perseguir', 'banda', 'pies',
 			'secundario', 'decisivo', 'clasificar', 'actuar', 'estruendoso', 'camino', 'negrita', 'comportarse', 'cubo', 'bombardero',
 			'compacto', 'acariciar', 'similar', 'despacho', 'enviar', 'pelea', 'puños', 'reemplazar', 'abandonar', 'responder', 'marcar',
 			'mezclada', 'saco', 'girar', 'apresurarse', 'entretener', 'bolsillo', 'estable', 'auspicioso', 'rayo', 'CortaR', 'GraciaS',
 			'EncantadoR', 'PesO', 'PesadO', 'EmitiR', 'GrasA', 'SusurraR', 'CerdO', 'FondO', 'AlmendrA', 'CoseR', 'CangrejO', 'ArquitectO',
 			'FantasmA', 'ExcesO', 'Caballos', 'Fuerza', 'ActriZ', 'PerseguiR', 'BandA', 'PieS', 'SecundariO', 'DecisivO', 'ClasificaR',
 			'ActuaR', 'EstruendosO', 'CaminO', 'NegritA', 'ComportarsE', 'CubO', 'BombarderO', 'CompactO', 'AcariciaR', 'SimilaR',
 			'DespachO', 'EnviaR', 'PeleA', 'PuñoS', 'ReemplazaR', 'AbandonaR', 'RespondeR', 'MarcaR', 'MezcladA', 'SacO', 'GiraR',
 			'ApresurarsE', 'EntreteneR', 'BolsillO', 'EstablE', 'AuspiciosO', 'RayO', 'C0rtaR', 'Grac1aS', 'Encantad0R', 'P3sO', 'P3sadO',
 			'Emit1R', 'Gr4sA', 'Susurr4R', 'C3rdO', 'F0ndO', 'Almen6rA', 'Co3eR', 'Can8rejO', 'Arquit5ctO', 'Fan7asmA', 'ExcesO', 'Caba11oS',
 			'Fu3rzA', 'Actr1Z', 'Pers3guiR', 'B4ndA', 'P1eS', 'Secund4riO', 'Dec1sivO', 'Clas1ficaR', 'Ac7uaR', 'Estru3ndosO', 'Cam1nO',
 			'Ne9ritA', 'Comp0rtarsE', 'C9bO', 'B0mbarderO', 'Comp4ctO', 'Acar1ciaR', 'Sim1laR', 'Desp4chO', 'Env1aR', 'Pe1eA', 'Puñ0S',
 			'Re3mplazaR', 'Aband0naR', 'Resp0ndeR', 'M4rcaR', 'Mezcl4dA', 'S4cO', 'G1raR', 'Apre5urarsE', 'Entr4teneR', 'Bols1llO', 'Est4blE',
 			'Ausp1ciosO', 'R4yO', '!C0rtaR', '"Grac1aS', '#Encantad0R', '$P3sO', '%P3sadO', '%Emit1R', '/Gr4sA', '(Susurr4R', ')C3rdO',
 			'=F0ndO', '!Almen6rA', '"Co3eR',
 		];
 		...
 		function startMatch() {
 			if (matchWords()) {
 				isPlaying = true;
 				showWord(words);
 				currentLevel = currentLevels[Math.floor(score / 10)];
 				wordInput.value = '';
 				seconds.innerHTML = currentLevel;
