...
if (!empty($_POST)) {
	...
	$stmt = $conn->prepare("INSERT INTO dificil (nombre, puntaje) VALUES (?, ?)");
...
<body style="background-image: url('../imagenes/tablero.png'); background-size: 1530px 750px; color:white;">
	...
	<div style="position:absolute; top: 13px; left: 15px">
		<a href="inicio-dificil.php"> <img src="../imagenes/regreso.png" alt="" width="60" height="60" /></a>
	</div>
	...
	<div style="position:absolute; top: 97px; left: 290px">
		<h2 align="center">Estas son las mejores puntuaciones para el nivel DIFICIL</h2>
	</div>
	<hr>
	<?php
	...
	<div style="position: absolute; top: 94%; left: 50%; transform: translate(-50%, -50%); text-align: center;">
		...
		<?php if ($puntaje ==  $objetivo) { ?>
			...
			<a class="boton_personalizado" href="../mixto/inicio-mixto.php">Siguiente nivel</a><?php
																							} else {
																								?>
			<a class="boton_personalizado" href="inicio-dificil.php">Repetir nivel</a>
		<?php
																							}
