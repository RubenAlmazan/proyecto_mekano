...
if (!empty($_POST)) {
	...
	$stmt = $conn->prepare("INSERT INTO mixto (nombre, puntaje) VALUES (?, ?)");
...
<body style="background-image: url('../imagenes/tablero.png'); background-size: 1530px 750px; color:white;">
	...
	<div style="position:absolute; top: 97px; left: 290px">
		<h2 align="center">Estas son las mejores puntuaciones para el nivel MUY DIFICIL</h2>
	</div>
	<hr>
	<?php
	...
	<div style="position: absolute; top: 94%; left: 50%; transform: translate(-50%, -50%); text-align: center;">
		...
		<?php if ($puntaje ==  $objetivo) { ?>
			...
			<a class="boton_personalizado" href="../principal/menu-principal.html">Regresar al Menu Principal</a><?php
																													...
																													?>
			<a class="boton_personalizado" href="inicio-mixto.php">Repetir nivel</a>
		<?php
																												}
