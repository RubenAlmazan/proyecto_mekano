...
if (!empty($_POST)) {
	...
	$stmt = $conn->prepare("INSERT INTO facil (nombre, puntaje) VALUES (?, ?)");
...
<body style="background-image: url('../imagenes/tablero.png'); background-size: 1530px 750px; color:white;">
	...
	<div style="position:absolute; top: 97px; left: 290px">
		<h2 align="center">Estas son las mejores puntuaciones para el nivel FÁCIL</h2>
	</div>
	<hr>
	<?php
    ...
    <?php if ($puntaje == $objetivo) { ?>
        <a class="boton_personalizado" href="../medio/inicio-medio.php">Siguiente nivel</a>
    <?php } else { ?>
        <a class="boton_personalizado" href="inicio-facil.php">Repetir nivel</a>
    <?php } ?>
