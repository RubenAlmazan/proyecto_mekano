...
<body style="background-image: url('../imagenes/pre---ejercicio.jpg'); background-size: 1365px 662px; color:white;">
	...
	<h1 align="center" style="color: white; line-height: 0%; text-shadow: 4px 4px 8px #333; position: relative; top: -5px;">BIENVENIDO AL NIVEL FÁCIL</h1>
	...
	<div style="position:absolute; top: 150px; left: 60px">
		...
		<br>
		<h4 align="center"> --- Tendrá 9 segundos por palabra --- </h4><br>
		<! –– y cada vez que aumente tu puntaje, se irá reduciendo el tiempo que tendrás para teclear cada palabra ––>
			<h3 align="center" style="line-height: 20%">Completa <b>30</b> palabras para pasar al siguiente nivel</h3> <br><br>
			<h4 align="center">En este nivel encontrarás: </h4>
			<h4 align="center">Palabras en minúsculas</h4>
	</div>
	...
	<div style="position:absolute; top: 170px; left: 940px">
		...
		echo "<tr> <th bgcolor='black' colspan='2' height='40'> Mejores puntuaciones - Fácil </th> </tr>";
	...
	<br><br>
	<div style="position:absolute; top: 590px; left: 360px">
		<a class="boton_personalizado" href="nivel-facil.php" style="text-decoration: none;">Iniciar NIVEL FÁCIL</a>
		<style type="text/css">
			.boton_personalizado {
				padding: 10px;
				font-weight: 600;
